...
upscale_downscale_image_1 = lib.bilinear_resize(downscale_image_1, image_1.shape[0], image_1.shape[1])

mse = lib.metric.mean_squared_error(image_1, upscale_downscale_image_1)

# b

cv2_downscale_image_1 = lib.resize_openCV(image_1, "down", 34, lib.cv2.INTER_LINEAR)
cv2_upscale_downscale_image_1 = lib.resize_openCV(cv2_downscale_image_1, "up", 300, lib.cv2.INTER_LINEAR)
...
cv2_downscale_image_1 = lib.resize_openCV(image_1, "down", 34, lib.cv2.INTER_LINEAR)
cv2_upscale_downscale_image_1 = lib.resize_openCV(cv2_downscale_image_1, "up", 295.5, lib.cv2.INTER_LINEAR)
