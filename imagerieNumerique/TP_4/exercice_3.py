...
# images = [image9, image9_stretch_rescale_intensity]
# labels = ["original image 9", "stretched image 9"]
# lib.affichage_rows_cols(1, 2, images, labels, 2, 'gray')
...
images = [image9_stretch_rescale_intensity_red,
          image9_stretch_rescale_intensity_green,
          image9_stretch_rescale_intensity_blue,
          image9_red_stretch_hist,
...
labels = ["image 9 red channel after stretching",
          "image 9 green channel after stretching",
          "image 9 blue channel after stretching",
          "image 9 red channel stretch hist (handmade)",
...
image9_stretch_rescale_intensity_percentile_red_gray = lib.convert_rgb_2_gray(
    image9_stretch_rescale_intensity_percentile_red)
image9_stretch_rescale_intensity_percentile_green_gray = lib.convert_rgb_2_gray(
    image9_stretch_rescale_intensity_percentile_green)
image9_stretch_rescale_intensity_percentile_blue_gray = lib.convert_rgb_2_gray(
    image9_stretch_rescale_intensity_percentile_blue)

image9_stretch_rescale_intensity_percentile_red_gray_hist = lib.get_image_histogram(
    image9_stretch_rescale_intensity_percentile_red_gray)
image9_stretch_rescale_intensity_percentile_green_gray_hist = lib.get_image_histogram(
    image9_stretch_rescale_intensity_percentile_green_gray)
image9_stretch_rescale_intensity_percentile_blue_gray_hist = lib.get_image_histogram(
    image9_stretch_rescale_intensity_percentile_blue_gray)
